...
const menuData = {
  ...
  sobremesas: [
    ...
    { name: "Purple Rain", nameEn: "Purple Rain", description: "Maracujá do Brasil, merengue e sorvete de manga", descriptionEn: "Brazilian passion fruit, meringue and mango sorbet", price: "12" },
