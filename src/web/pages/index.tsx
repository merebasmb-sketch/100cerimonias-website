        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          ...
          <div className="grid md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-amber-900/30 mb-24">
            {[
              ...
              },
              {
                ...
                text: lang === "pt" 
                  ? "El Txuletón e Wagyu — selecionados para uma experiência gastronómica única." 
                  : "El Txuletón and Wagyu — selected for a unique gastronomic experience.",
              },
              {
                icon: (
                  <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.2}>
          ...
          <div>
            ...
            <div className="grid md:grid-cols-3 gap-5">
              {[
                { name: "João M.", text: lang === "pt" ? "Uma experiência incrível! O El Txuletón estava perfeito e o ambiente é simplesmente espetacular. Voltarei certamente." : "An incredible experience! The El Txuletón was perfect and the atmosphere is simply spectacular. I will definitely return.", date: "Jan 2025" },
